...
public class SQLFormatterOptionsPanel extends JPanel
{
  ...
  private final JComboBox<EIndentMode> indentMode = new JComboBox<>(EIndentMode.values());
  private final JComboBox<ELineEnding> lineEnding = new JComboBox<>(ELineEnding.values());
  ...
  {
    return new Settings(
        (EIndentMode) Objects.requireNonNull(indentMode.getSelectedItem()),
        (ELineEnding) Objects.requireNonNull(lineEnding.getSelectedItem()),
  ...
  {
    indentMode.setSelectedItem(pSettings.getIndentMode());
    lineEnding.setSelectedItem(pSettings.getLineEnding());
    wordCaseMode.setSelectedItem(pSettings.getWordCaseMode());
    keywordCaseMode.setSelectedItem(pSettings.getKeywordCaseMode());
    _update();
  }
