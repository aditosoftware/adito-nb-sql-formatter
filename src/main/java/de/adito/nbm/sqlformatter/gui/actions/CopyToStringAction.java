package de.adito.nbm.sqlformatter.gui.actions;
...
@ActionRegistration(displayName = "Copy to JS-String")
...
public class CopyToStringAction implements ActionListener
{
	...
	public void actionPerformed(ActionEvent e)
	{
		try
		{
			...
			StatusDisplayer.getDefault().setStatusText("JS-String copied to clipboard.");
		}
