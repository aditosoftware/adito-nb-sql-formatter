...
import de.adito.nbm.sqlformatter.api.*;
...
public class Tokenizer implements ITokenizer
{
  ...
  private Token _nextReserved(@NotNull List<String> pList, @NotNull TokenType pTokenType)
  {
  ...
  public Token next()
  {
    ...
    Token nextReserved = _nextReserved(ISQLConstants.RESERVED_TOPLEVEL_WORDS, TokenType.RESERVED_TOPLEVEL);
    if (nextReserved != null) return nextReserved;
    nextReserved = _nextReserved(ISQLConstants.RESERVED_WRAPPING_WORDS, TokenType.RESERVED_WRAPPING);
    if (nextReserved != null) return nextReserved;
    nextReserved = _nextReserved(ISQLConstants.RESERVED_WORDS, TokenType.RESERVED);
    if (nextReserved != null) return nextReserved;
   ...
   */
  @NotNull
  private String _readWhile(@NotNull Function<Character, Boolean> pCheckFunc)
  {
